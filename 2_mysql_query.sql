...
CREATE TABLE `tb_mahasiswa` (
  ...
  `mhs_nim` varchar(25) NOT NULL,
  `mhs_nama` varchar(25) NOT NULL,
  `mhs_angkatan` varchar(25) NOT NULL
...
CREATE TABLE `tb_mahasiswa_nilai` (
  ...
  `mhs_id` varchar(25) NOT NULL,
  `mk_id` varchar(25) NOT NULL,
...
--
ALTER TABLE `tb_matakuliah`
  MODIFY `mk_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
